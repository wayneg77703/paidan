...
import { createDshHeadlessParser, detectDshRefusals, discoverDshModels } from '../dist/endpoints/dsh-headless.js'
...
test('model discovery reads the native settings.yaml agent-default-model block honestly', () => {
    ...
    assert.deepEqual(models, [{ alias: 'deepseek-official/deepseek-v4-flash-vision-exp', connection: 'deepseek-official' }])
