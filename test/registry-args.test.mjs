...
import { assertSafeSubstitutionValue, buildArgs, filterSafeAliases, pickProbePreset, withPromptCwdHint } from '../dist/endpoints/invocation.js'
...
test('buildEnv: effort env form applies the substituted fragment on top of command.env', async () => {
    const { buildEnv } = await import('../dist/endpoints/invocation.js')
